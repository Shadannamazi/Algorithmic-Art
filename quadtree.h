...
public:
    ...
    void renderHelper(PNG &img, Node* n) const;
    ...
    bool prunable(Node* node, int tol) ;
    /*
...
private:
    ...
    void clearQuadTree(Node* subTree);
    /**
    ...
    Node* copyQuadTree(Node* subTree);
    ...
    void computeNewUl(pair<int,int>& ul,int dim);
     ...
     * the derived class.
     */
    virtual bool prunable(Node* root, const int tol) const = 0;
